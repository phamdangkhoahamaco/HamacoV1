...
{
    public partial class rpphantichcongnochitiet : DevExpress.XtraReports.UI.XtraReport
    {
        public rpphantichcongnochitiet()
        {
            InitializeComponent();
        }
        ...
        public void gettieude(string a, string b, string c, string d)
        {
            try
            {
                xrTableCell5.Text = String.Format("{0:n0}", Double.Parse(d));
            }
            catch { }
