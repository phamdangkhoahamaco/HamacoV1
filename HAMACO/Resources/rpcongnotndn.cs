...
{
    public partial class rpcongnotndn : DevExpress.XtraReports.UI.XtraReport
    {
        public rpcongnotndn()
        {
            InitializeComponent();
        ...
        public void gettieude(string tungay, string denngay, string kho, string tsbt)
        {
            ...
            if (tsbt == "131tndnbh")
                xrLabel2.Text = "BẢNG KÊ HÓA ĐƠN BÁN HÀNG VÀ CHỨNG TỪ ĐÃ THANH TOÁN";
            else if (tsbt == "331tndnbh")
                xrLabel2.Text = "BẢNG KÊ HÓA ĐƠN MUA HÀNG VÀ CHỨNG TỪ ĐÃ THANH TOÁN";
            else
                xrLabel2.Text = "BẢNG KÊ TỔNG HỢP TÀI KHOẢN " + tsbt.Replace("tndn", "").Replace("tdv", "").Replace("tct", "").Replace("th","").Replace("tk","");
            try
            {
