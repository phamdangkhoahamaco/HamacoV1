...
{
    public partial class rpchitietcongnophieu : DevExpress.XtraReports.UI.XtraReport
    {
        public rpchitietcongnophieu()
        {
            InitializeComponent();
        }
        ...
        public void BindData(DataTable da)
        {
            ...
            xrTableCell40.DataBindings.Add("Text", DataSource, "Trọng lượng", "{0:n2}");
