...
{
    public partial class rpchitietcongnotomtat : DevExpress.XtraReports.UI.XtraReport
    {
        public rpchitietcongnotomtat()
        {
            InitializeComponent();
        }
        ...
        public void gettieude(string a, string b, string c, string d,string no,string co,string tsbt)
        {
           try
            ...
            try
            {
                xrTableCell28.Text = String.Format("{0:n0}", Double.Parse(co));
            }
            catch { }
            if (tsbt == "an")
            {
        ...
        public void BindData(DataTable da)
        {
            ...
            xrTableCell34.DataBindings.Add("Text", DataSource, "Lũy kế nợ", "{0:n0}");
            xrTableCell34.Summary = summarytotal5;

            summarytotal6.Running = SummaryRunning.None;
            summarytotal6.IgnoreNullValues = true;
            summarytotal6.FormatString = "{0:n0}";
            xrTableCell35.DataBindings.Add("Text", DataSource, "Lũy kế có", "{0:n0}");
            xrTableCell35.Summary = summarytotal6;

            summarytotal7.Running = SummaryRunning.Group;
            summarytotal7.IgnoreNullValues = true;
            summarytotal7.FormatString = "{0:n0}";
            xrTableCell30.DataBindings.Add("Text", DataSource, "Nợ đầu kỳ", "{0:n0}");
            xrTableCell30.Summary = summarytotal7;

            summarytotal8.Running = SummaryRunning.Group;
            summarytotal8.IgnoreNullValues = true;
            summarytotal8.FormatString = "{0:n0}";
            xrTableCell31.DataBindings.Add("Text", DataSource, "Có đầu kỳ", "{0:n0}");
            xrTableCell31.Summary = summarytotal8;

            summarytotal9.Running = SummaryRunning.Group;
            summarytotal9.IgnoreNullValues = true;
            summarytotal9.FormatString = "{0:n0}";
            xrTableCell32.DataBindings.Add("Text", DataSource, "Nợ phát sinh", "{0:n0}");
            xrTableCell32.Summary = summarytotal9;

            summarytotal10.Running = SummaryRunning.Group;
            summarytotal10.IgnoreNullValues = true;
            summarytotal10.FormatString = "{0:n0}";
            xrTableCell33.DataBindings.Add("Text", DataSource, "Có phát sinh", "{0:n0}");
            xrTableCell33.Summary = summarytotal10;
            ...
            xrTableCell27.DataBindings.Add("Text", DataSource, "Lũy kế có", "{0:n0}");
            xrTableCell37.DataBindings.Add("Text", DataSource, "Hóa đơn");
        }
