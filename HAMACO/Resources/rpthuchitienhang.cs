...
{
    public partial class rpthuchitienhang : DevExpress.XtraReports.UI.XtraReport
    {
        public rpthuchitienhang()
        {
            InitializeComponent();
        }
        ...
        public void BindData(DataTable da)
        {
            ...
            xrTableCell14.DataBindings.Add("Text", DataSource, "Khách hàng");
